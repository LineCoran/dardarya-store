...
function PriceModal() {
  ...
  const finalPrice =
    Number(allPriceInBYN) + Number(allPriceForDeliveryInChina) + Number(allPriceForDeliveryBLR);

  return (
    <div className='price-modal-wrapper'>
      <p>
        Курс доллара: <span style={{ fontWeight: '600' }}>${usd}</span>
      </p>
      <hr />
      <br />
      ...
      <br />
      <p>
        Общая масса товаров: <span style={{ fontWeight: '600' }}>{allWeightInBLR} кг.</span>
      </p>
      <p>
        Доставка по Китаю:{' '}
        <span style={{ fontWeight: '600' }}>{allPriceForDeliveryInChina} BYN</span>
      </p>
      <p>
